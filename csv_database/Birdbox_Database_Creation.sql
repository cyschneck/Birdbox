...
LOAD DATA LOCAL INFILE '/home/user/CSCI-3308-Group-Project/csv_database/display_info.csv' #takes the file at this directory and puts it into the table below.  Since
INTO TABLE display_info 																  #we're using .csv's, it parses by the delimeter ',' and ignores the first line so
FIELDS TERMINATED BY ','																  #we only get the data and don't have to deal with the headers where the data should
IGNORE 1 LINES 																			  #be.
